      ...
      <div className={clsx("portal-holo-panel", isActive && "active", exiting && "exiting")}>
        {loading ? (
          ...
          <div className="space-y-5">
            {/* 3D HERO + HOLO RINGS + METADATA ORBIT */}
            <div className="hero-3d-container">
              {/* Trait constellation behind everything */}
              ...
              <div className="hero-3d-wrapper">
                ...
                {/* Image or emblem fallback */}
                <img
                  src={strain?.hero_image || "/hero.png"}
                  className="hero-3d-image"
                />
              </div>

              {/* Floating metadata chips */}
              <div className="meta-chip top">
                {strain.type || "Unknown Type"}
              </div>

              <div className="meta-chip left">
                THC {strain.thc != null ? `${strain.thc}%` : "N/A"}
              </div>

              <div className="meta-chip right">
                CBD {strain.cbd != null ? `${strain.cbd}%` : "N/A"}
              </div>

              <div className="meta-chip bottom gold">
                {strain.primary_effect || "Balanced Vibes"}
              </div>
            </div>
